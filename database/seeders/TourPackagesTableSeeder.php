    ...
    public function run(): void
    {
        ...
        $cities = [
            [
                'name' => 'PALAWAN',
                'overview' => '',
                'image_url' => 'http://cavite-tiger-tours.test/storage/cities/fpA5tMrNM47lFZ3hx3WNCdWQXkjHFok2aU45OaLU.jpg',
            ],
            [
                'name' => 'CEBU',
                'overview' => '',
                'image_url' => 'http://cavite-tiger-tours.test/storage/cities/6p02TfKPjql8la1MreVUzdDFI3HUgQmcmTAulGTr.webp',
            ],
            [
                'name' => 'BOHOL',
                'overview' => '',
                'image_url' => 'http://cavite-tiger-tours.test/storage/cities/B8yk1TtW1bAjRwTFAcwYBUxThosYrDWidxpC5B7E.png',
            ],
            [
                'name' => 'DAVAO',
                'overview' => '',
                'image_url' => 'http://cavite-tiger-tours.test/storage/cities/GhDGXbsupHDn9A3m3Wkgjtasx1u8rkWrFTD360St.jpg',
            ],
            [
                'name' => 'ILO-ILO',
                'overview' => '',
                'image_url' => 'http://cavite-tiger-tours.test/storage/cities/VelPR8YJMk87AOCwGgmge0JZilijjHFVx4I2u6zR.webp',
            ],
            [
                'name' => 'AKLAN',
                'overview' => '',
                'image_url' => 'http://cavite-tiger-tours.test/storage/cities/JRIXcTrM7dUoAJkeh5nuihtkvZmYdXOd9aeOuTEx.jpg',
            ],
            [
                'name' => 'NEGROS OCCIDENTAL',
                'overview' => '',
                'image_url' => 'http://cavite-tiger-tours.test/storage/cities/KHaSDjf8b8oai3t7gAQLDBNTE9RsSaXzJ449zpBv.png',
            ],
            [
                'name' => 'CAGAYAN DE ORO + CAMIGUIN ISLAND',
                'overview' => '',
                'image_url' => 'http://cavite-tiger-tours.test/storage/cities/iOkcW2ZA38i0OkKx1BhZkyUHTEpN6MJrJOqdoN7L.webp',
            ],
            [
                'name' => 'NEGROS ORIENTAL',
                'overview' => '',
                'image_url' => 'http://cavite-tiger-tours.test/storage/cities/BOBpiWv0GKehivmniC7xUrIYHdmHnrY4MBPRlRgR.jpg',
            ],
            [
                'name' => 'SURIGAO DEL NORTE',
                'overview' => '',
                'image_url' => 'http://cavite-tiger-tours.test/storage/cities/HRRBP3QHwfxruLIBRvPmfDohz94e5XaiJGmUcfuL.jpg',
            ],
            [
                'name' => 'BATANES',
                'overview' => '',
                'image_url' => 'http://cavite-tiger-tours.test/storage/cities/JdxqRrEkSNiUBkBYia7MEDiwhh2ELharvT58YRFP.jpg',
            ],
        ];
        ...
        $packages = [
            [
                ...
                'image_overview' => 'http://cavite-tiger-tours.test/storage/packages/3Y8mZiGOTcDf4Knrmx6kOz8cZlhwaHq3jWmHWXv6.png',
                'image_banner' => ['http://cavite-tiger-tours.test/storage/packages/bG49Y0uNlYVix30pwdslWFoTEtHe7JIWtNcyKT2R.jpg'],
            ...
            [
                ...
                'image_overview' => 'http://cavite-tiger-tours.test/storage/packages/6jio80sCdPDiAPWQTtIEkbznSnsEPIokf1jb1EUd.jpg',
                'image_banner' => ['http://cavite-tiger-tours.test/storage/packages/aVA9R4Vuxd9dGBRh6170dk3gQjHEGassvxfsyZus.png'],
                'slug' => 'exploring-cebu',
                'base_price' => 4699.00,
            ],
            [
                ...
                'image_overview' => 'http://cavite-tiger-tours.test/storage/packages/YrYIkPsXToIk7C5y1u8wm2iXgFd8a1ZhFeM6QXtz.jpg',
                'image_banner' => ['http://cavite-tiger-tours.test/storage/packages/lKKpWlSyAQU7qVBxNku6Y50dgmHe4BflGLYdKA3B.jpg'],
            ...
            [
                ...
                'image_overview' => 'http://cavite-tiger-tours.test/storage/packages/uEI1bCATxGCB25OE2heUhtYWtLnyYON2cS4TWulO.jpg',
                'image_banner' => ['http://cavite-tiger-tours.test/storage/packages/riXygjRUG7vnITfzik7v0UvkhFCW0PeNeBBU7OKB.jpg'],
            ...
            [
                ...
                'image_overview' => 'http://cavite-tiger-tours.test/storage/packages/aPFH8L3FoFHEb7PBqdSsyteueQAvXNMG0Hdl4GCe.jpg',
                'image_banner' => ['http://cavite-tiger-tours.test/storage/packages/6wjO4Ym5A856ZMfkp4oMD0V3WDhmmFhFbJcZEjSs.jpg'],
                'slug' => 'el-nido',
                'base_price' => 7488.00,
            ],
            [
                ...
                'image_overview' => 'http://cavite-tiger-tours.test/storage/packages/zOwhT4r3qmpYzZ7dslqnLyt0Y7zBjQWIGRUK3Cph.png',
                'image_banner' => ['http://cavite-tiger-tours.test/storage/packages/M3Us5BKDXP9JWFCwhznFJOo7HqOJuYIlXaDl3XOZ.jpg'],
                'slug' => 'coron',
                'base_price' => 6488.00,
            ],
            [
                ...
                'image_overview' => 'http://cavite-tiger-tours.test/storage/packages/qyfdpzqFcB9mDiHDtDjtH84sAlbvE6demZsrwbCr.jpg',
                'image_banner' => ['http://cavite-tiger-tours.test/storage/packages/KgeiPCHiMeQWXGn8pQU8T8MyfFJx2pkx6YBMKkhI.jpg'],
            ...
            [
                ...
                'image_overview' => 'http://cavite-tiger-tours.test/storage/packages/IwZjzcmo3fcBzFrLycTF4sxmnZXk5pqv2ozDwQPz.png',
                'image_banner' => ['http://cavite-tiger-tours.test/storage/packages/qQJErkAqtyHGTjmaTZH2KereRMKciaGnCzEoBOam.png'],
                'slug' => 'dumaguete',
                'base_price' => 6388.00,
            ],
            [
                ...
                'image_overview' => 'http://cavite-tiger-tours.test/storage/packages/gr2Naw3t4RG0gr2wkunSHTdmwvjxTj8389ajFFIT.png',
                'image_banner' => ['http://cavite-tiger-tours.test/storage/packages/aFyOQkQZJaRyTadFK2r4VWOVfNxgKyhZo3ezcwS6.png'],
                'slug' => 'siargao',
                'base_price' => 8888.00,
            ],
            [
                ...
                'image_overview' => 'http://cavite-tiger-tours.test/storage/packages/ytahUMhkP0kywJrOV3OhFJOx8odwm6yL4nBmQ7ZH.jpg',
                'image_banner' => ['http://cavite-tiger-tours.test/storage/packages/peWGhfo1MITqadhjyvEGVISixbyCaedy9RmGSFXc.jpg'],
            ...
            [
                ...
                'image_overview' => 'http://cavite-tiger-tours.test/storage/packages/V5dKCee5MUjXVU7qKPUNWnyXn6rfmQvOzH5m2DrE.jpg',
                'image_banner' => ['http://cavite-tiger-tours.test/storage/packages/LMc1x8PbNBEw2AAFjGCoaulLwutqS4icrhFaUv1r.jpg'],
                'slug' => 'cebu-city-tour',
                'base_price' => 12888.00,
            ],
            [
                ...
                'image_overview' => 'http://cavite-tiger-tours.test/storage/packages/gdVMY6Rl6LMPksfjOyamycj4DC755T8UnH3bigmf.jpg',
                'image_banner' => ['http://cavite-tiger-tours.test/storage/packages/0v4JYwL55QG1cpOgqtt5bOLslBw4eL10KQEfid0m.jpg'],
            ...
            [
                ...
                'image_overview' => 'http://cavite-tiger-tours.test/storage/packages/RHA42rGH350DziPuFZRclNwHsUjQAUr3aU0zuxzn.jpg',
                'image_banner' => ['http://cavite-tiger-tours.test/storage/packages/6kEfN0XX3LxKMJMXN5Y3CRFzJlpcOmNKkvpPJLDX.webp'],
                'slug' => 'boracay',
                'base_price' => 4388.00,
            ],
            [
                ...
                'image_overview' => 'http://cavite-tiger-tours.test/storage/packages/4mPCgazDvdEMhLaS5moFShOFdwEU59IIWmnUbT4Y.jpg',
                'image_banner' => ['http://cavite-tiger-tours.test/storage/packages/duGws9483ZoqBNwsyAE8OSo5WzoYEWSBxvCbau0c.jpg'],
                'slug' => 'bacolod',
                'base_price' => 7488.00,
            ],
            [
                ...
                'image_overview' => 'http://cavite-tiger-tours.test/storage/packages/5jDj5MWAhKChc2mHUavjSbU6ImOKCDldjoMoTBGk.png',
                'image_banner' => ['http://cavite-tiger-tours.test/storage/packages/RxMHQIBFxrzsV4cYq58K7M48d039pHE1Chxg0GKg.jpg'],
            ...
            [
                ...
                'image_overview' => 'http://cavite-tiger-tours.test/storage/packages/BItkMRcVjKlWmHCDWLy3gTkfPNujuASDiSSJkoep.jpg',
                'image_banner' => ['http://cavite-tiger-tours.test/storage/packages/wu6GrH6xab2uBiiFJfeWbf2VQYUe47wuuEsVkgto.jpg'],
            ...
            [
                ...
                'image_overview' => 'http://cavite-tiger-tours.test/storage/packages/pbUOkLbQnDs8O2TWRMzkM3n5NpKuZNfz9EFngrIE.jpg',
                'image_banner' => ['http://cavite-tiger-tours.test/storage/packages/lYzFuewk4iHSYSD6NBAiMN3x2gf0ExOHAEulqU6h.jpg'],
                'slug' => 'cebu-bohol',
                'base_price' => 12888.00,
            ],
            [
                ...
                'overview' => 'Combines City highlights in Cebu with Bohol\'s natural and historical sites, often including a ferry ride and a day tour of Bohol\'s key attractions like the Chocolate Hills, Loboc River Cruise, and Tarsier sanctuary.',
                'content' => '<h1><strong>REQUIRED PAX [ Minimum of 2 PAX ]<br>DURATION [ 4 Days 3 Nights ]</strong></h1><h1><strong>DESCRIPTION</strong></h1><p>A Cebu and Bohol tour package typically combines city exploration in Cebu with natural attractions in Bohol, allowing you to see historical sites like Magellan\'s Cross in Cebu and natural wonders such as the Chocolate Hills and tarsiers in Bohol. Packages vary, but often include travel between the islands, guided tours of key attractions, and sometimes unique experiences like a Loboc River cruise with lunch. You can find options ranging from a single day trip to Bohol from Cebu, to a multi-day tour that covers more sites on both islands.</p><h1><strong>ITINERARY</strong></h1><h3><strong>[ DAY 1 ] ARRIVAL AT CEBU</strong></h3><p>Meet at the Airport and proceed to Hotel for Check-In.<br><strong>(Standard Check-In Time: 2:00 PM - 3:00 PM)</strong></p><h3><strong>[ DAY 2 ] CEBU CITY + UPHILL + 10,000 ROSES</strong></h3><p>Breakfast at Hotel, proceed to your designated Tour. After Tour Drop-Off at SM Cebu City (Guest own transfer back to Hotel).</p><p><strong>TOUR ITINERARY</strong></p><ul><li><p>Sirao Pictorial Garden and Camping Site</p></li><li><p>Fort San Pedro</p></li><li><p>Temple of Leah</p></li><li><p>Pasalubong Center Souvenir Shop</p></li><li><p>Taoist Temple</p></li><li><p>[Running Tour] Colon Street and CCLEX</p></li><li><p>Cebu Heritage Monument</p></li><li><p>10,000 Roses</p></li><li><p>Magellan\'s Cross</p></li><li><p>Basilica Minore del Sto. Niño de Cebu</p></li></ul><h3><strong>[DAY 3] CEBU TO BOHOL COUNTRYSIDE TOUR</strong></h3><p>Breakfast at Hotel, then proceed to Tagbilaran Port. Arrival in Bohol, Transfer to Bohol Countryside Tour, After Tour transfer to Hotel for Check In.</p><p><strong>PLACES TO VISIT</strong></p><ul><li><p>Chocolate Hills</p></li><li><p>Python Tarsier Conservatory</p></li><li><p>Blood Compact</p></li><li><p>Man-made Forest</p></li><li><p>Baclayon Church</p></li><li><p>Loboc River Floating Restaurant</p></li></ul><p><strong>*IMPORTANT NOTE</strong></p><p><strong>Child Rate:</strong> Less 5,000php/child (3-7 Years Old)</p><h3><strong>[DAY 4] BOHOL DEPARTURE</strong></h3><p>Breakfast, Free time until Check Out. Transfer to Airport for Departure.<br><strong>(Standard Check-Out Time: 12:00 NN)</strong></p><h1><strong>INCLUSION</strong></h1><ul><li><p>2 Nights Hotel Accommodation at Cebu (Rublin Hotel or Similar)</p></li><li><p>1 Night Hotel Accommodation at Bohol (MGH Alona Resort or Similar)</p></li><li><p>All Hotel taxes and surcharges</p></li><li><p>Daily Breakfast</p></li><li><p>Roundtrip Airport Transfer for both Cities (Private)</p></li><li><p>Ocean Jet Ticket (for Cebu To Bohol)</p></li><li><p>Cebu City Tour + Uphill + 10,000 Roses (Joiners)</p></li><li><p>Bohol Countryside Tour with Loboc River Lunch</p></li></ul><h1><strong>EXCLUSION</strong></h1><ul><li><p>Airfare</p></li><li><p>Travel Insurance</p></li><li><p>Others that are not mentioned above</p></li></ul><h1><strong>Reminders</strong></h1><ul><li><p>Rate is subject to change without prior notice</p></li><li><p>All rooms are subject to availability</p></li><li><p>Not applicable for Christmas, New Year, and Holidays</p></li></ul><h3><strong>*VALID UNTIL: December 2025</strong></h3><p>&nbsp;</p>',
                'image_overview' => 'http://cavite-tiger-tours.test/storage/packages/0IH16DECVrv8enZX8xyLwJ3YnMAcjLs4eMLjVJEx.jpg',
                'image_banner' => ['http://cavite-tiger-tours.test/storage/packages/S2PV0DJO4UT4VNlbRtHIujrI5VfwYlzWhlVyT4lo.jpg'],
                'slug' => 'cebu-bohol-1',
                'base_price' => 12888.00,
            ],
        ];
